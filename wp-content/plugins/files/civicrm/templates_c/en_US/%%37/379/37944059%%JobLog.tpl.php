<?php /* Smarty version 2.6.27, created on 2013-10-30 13:40:30
         compiled from CRM/Admin/Page/JobLog.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Admin/Page/JobLog.tpl', 27, false),array('function', 'crmURL', 'CRM/Admin/Page/JobLog.tpl', 35, false),array('function', 'cycle', 'CRM/Admin/Page/JobLog.tpl', 50, false),)), $this); ?>
<div id="help">
    <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This screen presents the list of scheduled jobs (cron tasks) log entries.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <?php echo $this->_tpl_vars['docLink']; ?>
