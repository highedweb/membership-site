...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php the_title( '<h2 class="entry-title"><a href="' . get_permalink() . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'minimalizine' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark">', '</a></h2>' ); ?>
		...
		<div class="entry-summary wide">
			<?php the_excerpt(); ?>
		</div><!-- .entry-summary -->
		<?php else : ?>
		<div class="entry-content wide">
			<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'minimalizine' ) ); ?>
