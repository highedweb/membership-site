...
?>                <section id="content" class="<?php echo is_active_sidebar( 'secondary-widget-area' ) ? "grid_6" : "grid_8 suffix_1" ?>">
					...
					if ( have_posts() )
						the_post(); ?>
						<h1 class="page-title author"><?php printf('Author Archives: %s', "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a></span>" ); ?></h1><?php
