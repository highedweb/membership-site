(function($) {
    ...
    $.fn.tweet = function(o) {
        var s = {
            ...
            template_directory: null                // [string]   blog template directory
        };
        ...
        return this.each(function() {
            ...
            $.getJSON(url, function(data) {
                ...
                $.each(data.results, function(i, item) {
                    ...
                    var actions = '<span class="tweet_actions"><a href="http://twitter.com/home?status=@' + item.from_user + '"><img src="' + s.template_directory + '/images/reply.png" alt="Reply"></a><a href="http://twitter.com/home?status=RT @' + item.from_user + ': ' + item.text + '"><img src="' + s.template_directory + '/images/retweet.png" alt="Retweet"></a></span>';

                    // until we create a template option, arrange the items below to alter a tweet's display.
                    list.append('<li>' + avatar + join + text + date + actions +'</li>');
