...
{/foreach}
{/if}
', 3, false),array('modifier', 'crmDate', 'string:***********************************************************
...
{/foreach}
{/if}
', 27, false),array('modifier', 'crmMoney', 'string:***********************************************************
...
{/foreach}
{/if}
', 39, false),array('modifier', 'string_format', 'string:***********************************************************
...
{/foreach}
{/if}
', 56, false),array('modifier', 'truncate', 'string:***********************************************************
