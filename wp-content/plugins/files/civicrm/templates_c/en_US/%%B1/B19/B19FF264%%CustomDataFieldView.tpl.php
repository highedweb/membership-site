...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Page/View/CustomDataFieldView.tpl', 27, false),array('function', 'crmURL', 'CRM/Contact/Page/View/CustomDataFieldView.tpl', 59, false),)), $this); ?>
<div id="custom-set-content-<?php echo $this->_tpl_vars['customGroupId']; ?>
          ...
          <?php if ($this->_tpl_vars['element']['field_type'] == 'File'): ?>
            <?php if ($this->_tpl_vars['element']['field_value']['displayURL']): ?>
                <div class="crm-content crm-custom_data crm-displayURL">
                  <a href="#" onclick="imagePopUp('<?php echo $this->_tpl_vars['element']['field_value']['imageURL']; ?>
'); return false;" ><img src="<?php echo $this->_tpl_vars['element']['field_value']['displayURL']; ?>
