<?php /* Smarty version 2.6.27, created on 2013-10-29 18:39:01
         compiled from CRM/Contact/Form/Search/table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Search/table.tpl', 32, false),array('modifier', 'crmAddClass', 'CRM/Contact/Form/Search/table.tpl', 39, false),)), $this); ?>
<div id="map-field">
...
?><?php echo ''; ?><?php $this->assign('i', $this->_sections['cols']['index']); ?><?php echo '<tr><td class="form-item even-row">'; ?><?php echo $this->_tpl_vars['form']['mapper'][$this->_tpl_vars['x']][$this->_tpl_vars['i']]['html']; ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['operator'][$this->_tpl_vars['x']][$this->_tpl_vars['i']]['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'required') : smarty_modifier_crmAddClass($_tmp, 'required')); ?><?php echo '&nbsp;&nbsp;<span class="crm-search-value" id="crm_search_value_'; ?><?php echo $this->_tpl_vars['x']; ?><?php echo '_'; ?><?php echo $this->_tpl_vars['i']; ?><?php echo '">'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['value'][$this->_tpl_vars['x']][$this->_tpl_vars['i']]['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'required') : smarty_modifier_crmAddClass($_tmp, 'required')); ?><?php echo '</span>'; ?><?php if ($this->_tpl_vars['i'] > 0 || $this->_tpl_vars['x'] > 1): ?><?php echo '&nbsp;&nbsp;<a href="#" class="crm-reset-builder-row" title="'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'Remove this row'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '"><img src="'; ?><?php echo $this->_tpl_vars['config']->resourceBase; ?><?php echo 'i/close.png" class="action-icon" alt="X" /></a>'; ?><?php endif; ?><?php echo '</td></tr>'; ?><?php endfor; endif; ?><?php echo '<tr class="crm-search-builder-add-row"><td class="form-item even-row underline-effect">'; ?><?php echo $this->_tpl_vars['form']['addMore'][$this->_tpl_vars['x']]['html']; ?><?php echo '</td></tr></table></div>'; ?><?php endfor; endif; ?><?php echo '<h3 class="crm-search-builder-add-block underline-effect">'; ?><?php echo $this->_tpl_vars['form']['addBlock']['html']; ?><?php echo '</h3>'; ?>
